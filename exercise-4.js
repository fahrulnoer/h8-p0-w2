...
if(tanggal < 1 || tanggal > 31){
    console.log('Perbaiki input tanggal!')
    return 
}else if( tahun < 1900 || tahun > 2300) {
    console.log('Perbaiki input tahun!')
    return 
}else if(bulan == 2){
    if(tanggal > 28){
        console.log("bulan Februari hanya 28 hari")
        return 
    }
}
switch(bulan) {
    ...
    break;
    default : console.log("Perbaiki input bulan!")
    break;
}